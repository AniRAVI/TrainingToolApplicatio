...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${background.jpg}/css/style.css" />
...
<div id="wrapper">
	...
	<form name="login-form" class="login-form" action="checkLogin" method="post">
		...
		<div class="content">
		<input id="username" name="username" type="text" class="input username" placeholder="Enter Att Id"  required="required"/>
		...
		<div class="footer">
		<input type="submit" name="submit" value="Login" class="button" id ="loginButton" />
		<a href="https://www.mozilla.org/en-US/firefox/new/" target="_newtab">Updated Browser</a>
